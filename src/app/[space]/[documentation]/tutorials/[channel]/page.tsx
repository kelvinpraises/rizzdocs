...
const page = () => {
  return (
    <>
      ...
      />
      <div className=" w-[300px] p-8 min-h-[300px] h-min flex flex-col rounded-[10px] bg-white  shadow-[0px_4px_15px_5px_rgba(226,229,239,0.25)] items-start sticky top-0">
