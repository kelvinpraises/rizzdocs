  ...
  return (
    <div className=" max-w-[420px] w-full flex flex-col gap-8 overflow-y-scroll">
      <Card1
        image={"timer.svg"}
        title={"New Space"}
        text={"Create a new space that reflects what a documentation is all about"}
      ...
      <Card1
        ...
        text={"Propose a new documentation to be added to and maintained by RizzDocs"}
      ...
      <Card1
        ...
        text={"Retro active fundings for amazing projects within the RizzDocs community "}
